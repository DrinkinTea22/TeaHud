...
Scheme
{
	...
	Colors
	{
	    ...
	    "TFTextMedium"              					"92 128 166 255"	// hover text color
	    "TFTextBlack"               					"92 128 166 155"	// selected text color
	    "TFTextDull"                					"178 178 178 255"	// disabled text
		
	    "TFTextMediumDark"          					"46 43 42 255"		// normal bg color
	    "TFTextBright"              					"80 80 80 255"		// hover bg color
	    "TFTanLightBright"          					"120 120 120 255"	// selected bg color
	    "TFMediumBrown"									"46 43 42 155"		// disabled bg color
		
	    "Blank"											"0 0 0 0"			// nothing
