...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"31 31 31 255" // Active window bg color
		"G_InctiveWindow"			"31 31 31 255" // Inactive window bg color
		"G_TitleBg"					"151 98 52 0" // Title bg color
		"G_TitleText"				"255 255 255 255" // Title text color
		"G_Highlight"				"40 39 39 240" // Highlight color
		"G_ConsoleBg"				"28 23 19 255" // Console bg color
		"G_ListBg"					"18 18 18 255" // List bg color
		"G_Border"					"0 0 0 50" // Border color
		"G_Text"					"179 179 179 255" // Text color
		"G_HighlightText"			"255 255 255 255" // Highlight text color
		"G_SelectedText"			"151 98 52 255" // Selected text color
		"G_DisabledText"			"179 179 179 196" // Disabled text color
		"G_ButtonBg"				"18 18 18 255" // Button bg color
		"G_ButtonText"				"214 206 200 255" // Button text color
		"G_ButtonHoverBg"			"151 98 52 255" // Button hover bg color
	    ...
	    "QuickListBGSelected"       "40 39 39 240" // Highlight color
